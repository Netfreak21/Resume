    ...
    private void onResolved() {
        switch (mMenuPosition){
            ...
            case DRAWER_MENU_ITEM_ASSIGNMENTS:
                ...
                itemIcon.setImageDrawable(mContext.getResources().getDrawable(R.drawable.ic_assignment_black_24dp));
                break;
            case DRAWER_MENU_ITEM_PROJECTS:
                itemNameTxt.setText("Projects");
                itemIcon.setImageDrawable(mContext.getResources().getDrawable(R.drawable.ic_content_copy_black_24dp));
                break;
            case DRAWER_MENU_ITEM_SHARE:
                itemNameTxt.setText("Share");
                itemIcon.setImageDrawable(mContext.getResources().getDrawable(R.drawable.ic_share_black_24dp));
                break;
